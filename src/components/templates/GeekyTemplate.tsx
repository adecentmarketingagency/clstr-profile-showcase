          ...
          <motion.section variants={fadeUp} initial="hidden" animate="visible" custom={idx++}>
            ...
            <div className="flex flex-wrap gap-3">
              {profile.skills.map((skill) => (
                <span key={skill} className="px-4 py-2 text-sm font-medium rounded-lg bg-gray-50 border border-gray-100 text-gray-700 hover:border-emerald-200 hover:bg-emerald-50 transition-colors">
                  {skill}
                </span>
              ))}
            </div>
